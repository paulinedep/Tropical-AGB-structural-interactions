...
Raw tree-by-tree data are not included in this repository due to confidentiality agreements with data 
contributors (ForestPlots.net, GFBI). Requests for tree-by-tree data 
should be directed to the relevant data networks. 
...
## Contact
If you encounter issues reproducing the analyses using this code, or 
have questions about collaboration, please contact the corresponding 
author: Pauline Depoortere (depoort.p@gmail.com)
---
